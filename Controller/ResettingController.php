...
class ResettingController extends BaseController
{
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        if (null === $user) {
            return $this->render('Auth/Resetting/request.html.twig', array(
                'invalid_username' => $username
            ));
        }

//        if ($user->isPasswordRequestNonExpired($this->container->getParameter('fos_user.resetting.token_ttl'))) {
//            return $this->render('Auth/Resetting/password_already_requested.html.twig');
//        }
    ...
    public function checkEmailAction(Request $request)
    {
        ...
        return $this->render('Auth/Resetting/check_email.html.twig', array(
            'email' => $email,
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        return $this->render('Auth/Resetting/reset.html.twig', array(
            'token' => $token,
